...
TASK_SESSION_ADVANCE: Final[str] = "session.advance"
...
TASK_QUEUES: Final[dict[str, str]] = {
    ...
    # The run loop rides the maintenance queue, not `apply`: it dispatches application
    # work and never performs any, so it must not queue behind the browser flows it is
    # supposed to be pacing.
    TASK_SESSION_ADVANCE: QUEUE_MAINTENANCE,
